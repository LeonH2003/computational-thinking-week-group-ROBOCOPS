def name():
    return "Maliah"
def act1():
    return "Helo, I'm Maliah, I am a fruit bat. I liek fruits and sleeping. I sleep in friut trees that are at least too meters tall. My faverit furit is raspbery. I also am living in teh forest with the others, the syren, wicth, mermaid, dragon, and knight "
def act2():
