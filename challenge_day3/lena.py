...
def act3():
    return "The dragon proceeds to challenge the knight to a robot dance off in order to win the advances of the mermaid. He looses as his body is too large and stiff to properly liken a robot. Not enough to impress the startled mermaid. Better luck next time."